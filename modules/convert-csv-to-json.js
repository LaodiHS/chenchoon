...
const { makeDirectoryPaths, writeFile, fileInformation, isDirectory, dir, readFile } = require("./personalized_file_system.js")
...
async function write_files(json, dirName) {
  ...
  for (let key in root) {
    ...
    try {
      await writeFile(`${dirName}/${files[key]}`, result, { flag: 'w' })
