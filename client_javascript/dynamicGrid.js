...
document.dynamicGrids = function dynamicGrids(_gridSize = 100, _gridDimentions = 100, _gridGap = 0) {
    ...
    const gridRow = _gridDimentions || +document.getElementById('grid').getAttribute('dimension');
    const gridCol = _gridDimentions || +document.getElementById('grid').getAttribute('dimension');
